...
Debug On the Fly Character Switcher v1.4 [Magus, Krisan Thyme, Eon]
...
loc_0x9C:
  ...
  bne+ loc_0xD0
  add r30, r30, r26
  cmpwi r30, 0x2D 			#if >= 0x2D, return to 0
  blt+ loc_0xB8
  subi r30, r30, 0x2D 		#0x2E -> 0x1

loc_0xB8:
  cmpwi r30, 0x0 			#if < 0, return to 0x30
  bge+ loc_0xC4
  addi r30, r30, 0x2D 		#-1 -> 0x2C
...
0x26, 0x32, 0x03, 0x04, |	#Robot (R.O.B.), Roy, Samus, SZeroSuit (Zero Suit Samus)
0x2A, 0x2B, 0x28, 0x17, |	#Snake, Sonic, Toon Link, Wario
0x2D, 0x29, 0x05, 0x0E, |	#Wario ManWolf, Yoshi, Zelda
0x0F  					|   #Sheik
@ $80583FB0
