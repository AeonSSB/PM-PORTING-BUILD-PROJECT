...
checkForAutoLcancel:                
  ...
  lwz r12, 0x08(r31)                # Grab the Fighter* from our ModuleAccesser...
  lbz r12, 0x10F(r12)               # ... and from there grab the bottom byte of the EntryID (0x10C), which is the Fighter's Slot Number!
